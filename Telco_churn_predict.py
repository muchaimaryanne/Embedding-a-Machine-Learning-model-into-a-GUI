...
banner_html = "<img src='https://www.bmdlk.com/wp-content/uploads/2022/03/Telco.png' style='display: block; margin: auto; max-width: 100%; max-height: 400px;'>"

gr.Interface(fn=predict, inputs=input_interface, outputs=output_table,title="Customer Churn Prediction",description=banner_html).launch()
